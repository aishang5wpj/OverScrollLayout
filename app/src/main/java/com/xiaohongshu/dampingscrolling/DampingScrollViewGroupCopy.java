 ...
 */
public class DampingScrollViewGroupCopy extends FrameLayout {
    ...
    public DampingScrollViewGroupCopy(Context context) {
        this(context, null);
    }

    public DampingScrollViewGroupCopy(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DampingScrollViewGroupCopy(Context context, AttributeSet attrs, int defStyleAttr) {
